...
<body>
  ...
  <div class="container mb-5 pb-5">
    ...
    <form id="paymentForm" method="POST" action="../pay.php" class="row">
      <div class="col-md-4 order-md-2 mb-4">
        ...
        <ul class="list-group mb-3">
          ...
          <li class="list-group-item d-flex justify-content-between lh-condensed">
            <div>
              <h4 class="highlights"><?php echo $title; ?></h4>
            </div>
          </li>
          <li class="list-group-item d-flex justify-content-between lh-condensed">
            <div>
          ...
          <li class="list-group-item d-flex justify-content-between bg-light">
            <div class="text-success">
              <h6 class="my-0">Extra Discount</h6>
              <small></small>
            </div>
            <span class="text-success">-₹<?= $price - $sell; ?></span>
          </li>
          <li class="list-group-item d-flex justify-content-between bg-light">
            <div class="text-success">
          ...
          <li class="list-group-item d-flex justify-content-between">
            <span>Total (INR)</span>
            <strong>₹<?php echo $sell; ?></strong>
          </li>
          <input type="hidden" id="amount" name="amount" value="<?php echo $sell; ?>">
        </ul>
        <div class="card p-2">
              ...
              <div class="col-md-4">
                <div class="footer-widget">
                  ...
                  <ul class="p-0">
                    ...
                    <li><a href="./all-Packages">Packages</a></li>
