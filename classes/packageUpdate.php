...
// Update package by no (auto-incremented field)
    public function updatePackage($no, $name, $title, $subtitle, $days, $price, $sell, $fromD, $toD, $schedule, $inclusion, $exclusion, $hotel, $photo1, $photo2, $photo3, $photo4, $photo5, $photo6) {
        ...
        $sql = "UPDATE package SET name = :name, title = :title, subtitle = :subtitle, days = :days, price = :price, sell = :sell, fromD = :fromD, toD = :toD, schedule = :schedule, inclusion = :inclusion, exclusion = :exclusion, hotel = :hotel, photo1 = :photo1, photo2 = :photo2, photo3 = :photo3, photo4 = :photo4, photo5 = :photo5, photo6 = :photo6 WHERE id = :no";
        $stmt = $this->conn->prepare($sql);
