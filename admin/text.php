...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="info.php">Information</a>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!-- <li class="nav-item dropdown no-arrow d-sm-none" style="display: no;">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Total Interaction</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">10.35K</div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Weekly Traffic</h6>
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Our Sales</h6>
                                </div>
                                <div class="card-body">
    ...
    <script>
        ...
        var yValues = [75, 45, 44, 25, 35, 40 ,85];
        var barColors = ["red", "green","blue","orange","Tomato" ,"Olive","MediumVioletRed"];
