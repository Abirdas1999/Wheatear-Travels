<?php
include_once './admin/classes/qUpdate.php';
$qUpdate = new QUpdate();
$qUpdates = $qUpdate->getAllEnquiries();
                                    ...
                                    <table class="table table-striped table-bordered" id="crudTable">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                foreach ($qUpdates as $qu): ?>
                                            <tr>
                                                <td><?php echo $qu["id"]; ?></td>
                                                <td><?php echo $qu["name"]; ?></td>
                                                <td><?php echo $qu["mail"]; ?></td>
                                                <td><?php echo $qu["phone"]; ?></td>
                                                <td><?php echo $qu["message"]; ?></td>
