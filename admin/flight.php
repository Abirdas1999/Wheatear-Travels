            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h3 mb-0 text-gray-800">Enquiry of Flights</h1>
                            </div>
                        </div>
                            ...
                            <table class="table table-bordered table-striped">
                                <tbody>
                                    <tr class="thead-dark">
                                        ...
                                        <th>checkin</th>
                                        <th>checkout</th>
                                        <th>timepreference</th>
                                        <th>deperturecity</th>
                                        <th>destinationcity</th>
                                        <th>passenger</th>
                                        <th>passengerpreference</th>
                                        <th>classpreference</th>
                                        ...
                                        if(mysqli_num_rows($query_run) > 0)
                                        {
                                            foreach($query_run as $row)
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $row['checkin']; ?></td>
                                                    <td><?= $row['checkout']; ?></td>
                                                    <td><?= $row['timepreference']; ?></td>
                                                    <td><?= $row['deperturecity']; ?></td>
                                                    <td><?= $row['destinationcity']; ?></td>
                                                    <td><?= $row['passenger']; ?></td>
                                                    <td><?= $row['passengerpreference']; ?></td>
                                                    <td><?= $row['classpreference']; ?></td>
