...
if (isset($_POST['submit'])) {
    $package = new PackageUpdate();

    // Set package details
    $package->setName($_POST['name']);
    $package->setTitle($_POST['title']);
    $package->setSubtitle($_POST['subtitle']);
    $package->setDays($_POST['days']);
    $package->setPrice($_POST['price']);
    $package->setSell($_POST['sell']);
    $package->setFromD($_POST['fromD']);
    $package->setToD($_POST['toD']);
    $package->setSchedule($_POST['schedule']);
    $package->setInclusion($_POST['inclusion']);
    $package->setExclusion($_POST['exclusion']);
    $package->setHotel($_POST['hotel']);
    ...
    try {
        $package->addPackage($files);
        header('Location: package.php'); // Redirect on success
        exit();
    } catch (Exception $e) {
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <form action="package.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2 form-group">
                                                ...
                                                <textarea name="hotel" id="hotel" class="form-control" cols="30" rows="10"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2 form-group">
                                                ...
                                                <textarea name="inclusion" id="inclusion" class="form-control" cols="30" rows="10"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2 form-group">
                                                ...
                                                <textarea name="exclusion" id="exclusion" class="form-control" cols="30" rows="10"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2 form-group">
                                                ...
                                                <textarea name="schedule" id="schedule" class="form-control" cols="30" rows="10"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <input type="hidden" name="id" value="<?php echo isset($user_id) ? htmlspecialchars($user_id) : ''; ?>">
                        <button type="submit" name="submit" class="btn btn-default btn-info  mt-3 text-light px-5 py-3">Submit</button>
                    </form>
